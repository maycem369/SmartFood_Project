...
<div class="admin-layout">
    ...
    <nav class="admin-navbar">
        <div class="logo-area">
            <h1>Smart<span>Food</span> <small>Admin</small></h1>
        </div>
        <ul class="nav-links">
            <li class="active"><a href="backoffice.php">🍽️ Recettes</a></li>
            <li><a href="#">🔥 Calories</a></li>
            <li><a href="#">⚙️ Paramètres</a></li>
            <li><a href="frontoffice.php" class="admin-link">← Front Office</a></li>
        </ul>
        <div class="user-menu">
            <span>Admin</span>
    ...
    <div class="backoffice-container">
        ...
        <div class="section-card">
            ...
            <form method="GET" class="filter-row">
                ...
                <a href="backoffice.php" class="btn btn-cancel">Reset</a>
            </form>
