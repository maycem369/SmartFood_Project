...
<head>
    ...
    <style>
        ...
        .recipe-photo-placeholder {
            ...
            height: 180px;
            border-radius: 16px;
            background: linear-gradient(135deg, var(--green-tint), #e8f5ee);
            display: flex;
            align-items: center;
...
<div class="dashboard-container">
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            <li><a href="frontoffice.php" class="active">🍽️ Recettes</a></li>
            <li><a href="#">🔥 Calories</a></li>
            <li><a href="#">👤 Profil</a></li>
        </ul>

        <div class="switch-mode">
            <a href="backoffice.php" class="admin-link"
               style="display:flex;align-items:center;gap:8px;padding:12px 16px;border-radius:12px;color:var(--front-orange);font-weight:600;font-size:.88rem;">
                ⚙️ Back Office <small style="opacity:.7;">(Admin)</small>
            </a>
        </div>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="card" style="padding: 20px 24px; margin-bottom: 20px;">
            <div class="category-filter">
                ...
                <a href="frontoffice.php?categorie=<?= urlencode($cat) ?>"
        ...
        <div class="card bento-item-form">
            ...
            <form method="GET">
                ...
                <div class="flex" style="gap:10px;flex-wrap:wrap;">
                    ...
                    <a href="frontoffice.php" class="btn btn-cancel">↺ Reset</a>
                </div>
            </form>
        </div>

        <!-- ── RESULTS HEADER ────────────────────────────── -->
        <div class="justify-between" style="margin: 10px 0;">
